          ...
          <Row className="d-flex">
            ...
            <Col md={4} className="align-self-center">
              <Row className="d-flex justify-content-center align-items-baseline">
                <Col md={1} sm={12}>
                  <img
                    src={"https://cdn-icons-png.flaticon.com/512/70/70229.png"}
                    width={"25px"}
                ...
                <Col md={1} sm={12}>
                  <img
                    src={"https://cdn-icons-png.flaticon.com/512/70/70082.png"}
                    width={"25px"}
    ...
    const handleSearch = (event) => {
      ...
      allItems = allItems.filter((item) => {
        ...
        return (
          ...
          item.role.toLowerCase().includes(txt)
        );
      });
      ...
      if (allItems.length > 0) {
        ...
        window.alert("No Matching result Found! Try with some other keyword");
        event.target.value = "";
      }
    };
    return (
                      ...
                      <tbody>
                        <tr key={index}>
                          ...
                          <td>
                            <img
                              src={
                                "https://cdn-icons-png.flaticon.com/512/2344/2344147.png"
                              }
                              width={"40px"}
                              alt="save"
                              onClick={() => {
                            ...
                            <img
                              src={
                                "https://cdn-icons-png.flaticon.com/512/391/391247.png"
                              }
                              width={"40px"}
                              alt="cancel"
                              onClick={() => {
                    ...
                    <tr id={`tr-${data.id}`} key={index}>
                      <td>
                        <input
                          ...
                          onClick={() => handleToggleClass(`tr-${data.id}`)}
                        />
                      </td>
                      <td>{data.name}</td>
                      <td>{data.email}</td>
  ...
  return (
    <>
      {showEdit == null ? (
        ...
        <PaginatedItems itemsPerPage={"Edit"} />
      )}
    </>
  );
}
